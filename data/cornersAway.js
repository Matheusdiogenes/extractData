...
const gamesP1 = require(`./json/ta1.json`) 
...
const gamesP2 = require(`./json/ta2.json`) 
...
lado1.forEach( (element, i) => {    
    ...
    // total
    if(lado2[i] === team && i < quantidadeJogos){
    ...
    // mando
    if(lado2[i] === team && controlMando < quantidadeMando){      
      controlMando++      
      feitosMando += lado2FeitosFT
      sofridosMando += lado1FeitosFT
      feitosHTmando += lado2FeitosHT
      sofridosHTmando += lado1FeitosHT
      if(lado2FeitosFT > 4){
